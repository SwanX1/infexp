...
public class BasaltGiantEntity extends PathfinderMob implements IEntityAdditionalSpawnData, NeutralMob {
...
//    }
	...
	public EntityDimensions getDimensions(Pose poseIn) {
		return super.getDimensions(poseIn).scale(getGiantSize());
	}
