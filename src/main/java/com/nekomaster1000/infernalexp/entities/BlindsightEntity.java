...
*/
    ...
    protected void dealDamage(LivingEntity entityIn) {
        if (this.isAlive()) {
            if (this.canSee(entityIn) && entityIn.hurt(DamageSource.mobAttack(this), (float)this.getAttributeValue(Attributes.ATTACK_DAMAGE))) {
        ...
        public boolean canUse() {
            if (this.leaper.isVehicle()) {
                ...
                if (this.leapTarget == null || !(this.leapTarget instanceof GlowsquitoEntity)) {
                    ...
                    double d3 = Mth.sqrt(d1 * d1 + d2 * d2);
    ...
    public static class MoveHelperController extends MoveControl {
        ...
        public MoveHelperController(BlindsightEntity blindsightIn) {
            super(blindsightIn);
            this.blindsight = blindsightIn;
            this.yRot = 180.0F * blindsightIn.yRot / (float) Math.PI;
        }
    ...
    static class AttackGoal extends Goal {
        ...
        public void tick() {
            ...
            ((BlindsightEntity.MoveHelperController) this.blindsight.getMoveControl()).setDirection(this.blindsight.yRot);
        }
    }
