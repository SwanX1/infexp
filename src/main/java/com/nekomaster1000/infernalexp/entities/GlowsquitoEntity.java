...
public class GlowsquitoEntity extends Animal implements FlyingAnimal {
	...
	@Override
	public GlowsquitoEntity getBreedOffspring(ServerLevel world, AgableMob parent) {
	...
	static class LookAroundGoal extends Goal {
		...
		public void tick() {
			...
			this.parentEntity.yRot = -((float) Mth.atan2(vector3d.x, vector3d.z)) * (180F / (float) Math.PI);
	...
	class WanderGoal extends Goal {
		...
		private Vec3 getRandomLocation() {
			...
			Vec3 vector3d2 = RandomPos.getAboveLandPos(GlowsquitoEntity.this, 8, 7, vector3d, ((float) Math.PI / 2F), 2, 1);
			return vector3d2 != null ? vector3d2 : RandomPos.getAirPos(GlowsquitoEntity.this, 8, 4, -2, vector3d, (float) Math.PI / 2F);
		}
	}
