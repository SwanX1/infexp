...
public class IEBlocks {
  ...
  /*			single file in /blockstates pulls from (potentially multiple files in)
    ...
    // Blocks
    public static final RegistryObject<Block> DIMSTONE = registerBlockWithDefaultItem("dimstone", () -> new Block(getProperties(Material.GLASS, 1.8F, 2.0F).sound(IESoundEvents.DIMSTONE_TYPE).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).lightLevel(value -> 12)));
    public static final RegistryObject<Block> DULLSTONE = registerBlockWithDefaultItem("dullstone", () -> new Block(getProperties(Material.GLASS, 1.5F, 6.0F).sound(IESoundEvents.DULLSTONE_TYPE).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> SMOOTH_GLOWSTONE = registerBlockWithDefaultItem("smooth_glowstone",    () -> new Block(getProperties(Material.GLASS, 1.5F, 6.0F).sound(SoundType.GLASS).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).lightLevel(value -> 15)));
    public static final RegistryObject<Block> SMOOTH_DIMSTONE = registerBlockWithDefaultItem("smooth_dimstone",      () -> new Block(getProperties(DIMSTONE.get()).strength(1.5F, 6.0F).lightLevel(value -> 12)));
    public static final RegistryObject<Block> SMOOTH_DULLSTONE = registerBlockWithDefaultItem("smooth_dullstone",    () -> new Block(getProperties(DULLSTONE.get()).strength(1.5F, 6.0F)));
    ...
    public static final RegistryObject<Block> SMOOTH_GLOWSTONE_STAIRS = registerBlockWithDefaultItem("smooth_glowstone_stairs",   () -> new StairBlock(() -> SMOOTH_GLOWSTONE.get().defaultBlockState(), getProperties(SMOOTH_GLOWSTONE.get())));
	public static final RegistryObject<Block> SMOOTH_GLOWSTONE_BUTTON = registerBlockWithDefaultItem("smooth_glowstone_button",   () -> new StoneButtonBlock(getProperties(Material.DECORATION, 0.5F).sound(SoundType.GLASS).lightLevel(value -> 15).noCollission()));
	public static final RegistryObject<Block> SMOOTH_GLOWSTONE_PRESSURE_PLATE = registerBlockWithDefaultItem("smooth_glowstone_pressure_plate", () -> new LightUpPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, getProperties(SMOOTH_GLOWSTONE.get()).lightLevel(getLightValueLit(15))));
    ...
    public static final RegistryObject<Block> SMOOTH_DIMSTONE_STAIRS = registerBlockWithDefaultItem("smooth_dimstone_stairs",     () -> new StairBlock(() -> SMOOTH_DIMSTONE.get().defaultBlockState(), getProperties(SMOOTH_DIMSTONE.get())));
	public static final RegistryObject<Block> SMOOTH_DIMSTONE_BUTTON = registerBlockWithDefaultItem("smooth_dimstone_button",     () -> new StoneButtonBlock(getProperties(Material.DECORATION, 0.5F).sound(SoundType.GLASS).lightLevel(value -> 12).noCollission()));
    ...
    public static final RegistryObject<Block> SMOOTH_DULLSTONE_STAIRS = registerBlockWithDefaultItem("smooth_dullstone_stairs",   () -> new StairBlock(() -> SMOOTH_DULLSTONE.get().defaultBlockState(), getProperties(SMOOTH_DULLSTONE.get())));
    public static final RegistryObject<Block> SMOOTH_DULLSTONE_BUTTON = registerBlockWithDefaultItem("smooth_dullstone_button",   () -> new StoneButtonBlock(getProperties(Material.DECORATION, 0.5F).sound(IESoundEvents.DULLSTONE_TYPE).noCollission()));
    ...
    public static final RegistryObject<Block> GLOWSTONE_BRICK_STAIRS = registerBlockWithDefaultItem("glowstone_brick_stairs",     () -> new StairBlock(() -> GLOWSTONE_BRICKS.get().defaultBlockState(), getProperties(GLOWSTONE_BRICKS.get())));
    ...
    public static final RegistryObject<Block> DIMSTONE_BRICK_STAIRS = registerBlockWithDefaultItem("dimstone_brick_stairs", () -> new StairBlock(() -> DIMSTONE_BRICKS.get().defaultBlockState(), getProperties(DIMSTONE_BRICKS.get())));
    ...
    public static final RegistryObject<Block> DULLSTONE_BRICK_STAIRS = registerBlockWithDefaultItem("dullstone_brick_stairs", () -> new StairBlock(() -> DULLSTONE_BRICKS.get().defaultBlockState(), getProperties(DULLSTONE_BRICKS.get())));
    ...
    public static final RegistryObject<Block> LUMINOUS_WART_BLOCK = registerBlockWithDefaultItem("luminous_wart_block", () -> new Block(getProperties(Blocks.NETHER_WART_BLOCK).lightLevel(value -> 8)));

    public static final RegistryObject<Block> GLOWDUST_SAND = registerBlockWithDefaultItem("glowdust_sand", () -> new GlowSandBlock(0xFFC267, BlockBehaviour.Properties.of(Material.SNOW, MaterialColor.SAND).requiresCorrectToolForDrops().harvestTool(ToolType.SHOVEL).strength(0.5F).sound(SoundType.SAND)));
    public static final RegistryObject<Block> GLOWDUST = registerBlockWithDefaultItem("glowdust", () -> new GlowdustBlock(BlockBehaviour.Properties.of(Material.TOP_SNOW, MaterialColor.SAND).requiresCorrectToolForDrops().harvestTool(ToolType.SHOVEL).strength(0.2f).sound(SoundType.SAND)));
    public static final RegistryObject<Block> TRAPPED_GLOWDUST_SAND = registerBlockWithDefaultItem("trapped_glowdust_sand", () -> new TrappedGlowSandBlock(0xFFC267, getProperties(GLOWDUST_SAND.get()).strength(0.2F).lightLevel(value -> 5)));
    ...
    public static final RegistryObject<Block> GLOWDUST_STONE_STAIRS = registerBlockWithDefaultItem("glowdust_stone_stairs", () -> new StairBlock(() -> GLOWDUST_STONE.get().defaultBlockState(), getProperties(GLOWDUST_STONE.get())));
    ...
    public static final RegistryObject<Block> GLOWDUST_STONE_BRICK_STAIRS = registerBlockWithDefaultItem("glowdust_stone_brick_stairs",  () -> new StairBlock(() -> GLOWDUST_STONE_BRICKS.get().defaultBlockState(), getProperties(GLOWDUST_STONE_BRICKS.get())));
	...
	public static final RegistryObject<Block> CRUMBLING_BLACKSTONE = registerBlockWithDefaultItem("crumbling_blackstone", () -> new CrumblingBlackstoneBlock(BlockBehaviour.Properties.copy(Blocks.NETHERRACK)));
	...
	public static final RegistryObject<Block> BASALT_STAIRS = registerBlockWithDefaultItem("basalt_stairs",	() -> new StairBlock((Blocks.BASALT)::defaultBlockState, getProperties(Blocks.BASALT)));
    ...
    public static final RegistryObject<Block> BASALT_BRICK_STAIRS = registerBlockWithDefaultItem("basalt_brick_stairs", () -> new StairBlock(() -> BASALT_BRICKS.get().defaultBlockState(), getProperties(BASALT_BRICKS.get())));
	...
	public static final RegistryObject<Block> SOUL_SAND_STAIRS = registerBlockWithDefaultItem("soul_sand_stairs",	() -> new StairBlock(Blocks.SOUL_SAND::defaultBlockState, getProperties((Blocks.SOUL_SAND))));
	...
	public static final RegistryObject<Block> SOUL_SOIL_STAIRS = registerBlockWithDefaultItem("soul_soil_stairs",	() -> new StairBlock(Blocks.SOUL_SOIL::defaultBlockState, getProperties(Blocks.SOUL_SOIL)));
    ...
    public static final RegistryObject<Block> SOUL_STONE_STAIRS = registerBlockWithDefaultItem("soul_stone_stairs",() -> new StairBlock(Blocks.COBBLESTONE::defaultBlockState, getProperties(Blocks.SOUL_SOIL)));
	...
	public static final RegistryObject<Block> SOUL_SLATE_STAIRS = registerBlockWithDefaultItem("soul_slate_stairs",	() -> new StairBlock(() -> SOUL_SLATE.get().defaultBlockState(), getProperties(SOUL_SLATE.get())));
	...
	public static final RegistryObject<Block> SOUL_SLATE_PRESSURE_PLATE = registerBlockWithDefaultItem("soul_slate_pressure_plate", () -> new LightUpPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, getProperties(SOUL_SLATE.get()).lightLevel(getLightValueLit(15))));
    ...
    public static final RegistryObject<Block> SOUL_STONE_BRICK_STAIRS = registerBlockWithDefaultItem("soul_stone_brick_stairs",	() -> new StairBlock(() -> SOUL_STONE_BRICKS.get().defaultBlockState(), getProperties(SOUL_STONE_BRICKS.get())));
	...
	public static final RegistryObject<Block> SOUL_SLATE_BRICK_STAIRS = registerBlockWithDefaultItem("soul_slate_brick_stairs",	() -> new StairBlock(() -> SOUL_SLATE_BRICKS.get().defaultBlockState(), getProperties(SOUL_SLATE_BRICKS.get())));
	...
	public static final RegistryObject<Block> GLOW_LANTERN = registerBlockWithDefaultItem("glow_lantern", () -> new Lantern(getProperties(Blocks.LANTERN)));
	...
	public static final RegistryObject<Block> GLOWSILK_COCOON = registerBlockWithDefaultItem("glowsilk_cocoon", () -> new RotatedPillarBlock(getProperties(Material.LEAVES).sound(SoundType.WOOL).requiresCorrectToolForDrops().harvestTool(ToolType.HOE).harvestLevel(3).strength(5.0F, 1200.0F).lightLevel(value -> 5)));
	// Foliage
	...
	public static final RegistryObject<Block> DULLTHORNS = registerBlock("dullthorns", () -> new DullthornsBlock(BlockBehaviour.Properties.of(Material.PLANT).lightLevel(value -> 3).noCollission().randomTicks().strength(0.1F).sound(SoundType.GRASS)));

	public static final RegistryObject<Block> DULLTHORNS_BLOCK = registerBlockWithDefaultItem("dullthorns_block", () -> new DullthornsBlockBlock(BlockBehaviour.Properties.of(Material.CACTUS).strength(0.2F).sound(SoundType.WART_BLOCK)));
	...
	public static final RegistryObject<PlantedQuartzBlock> PLANTED_QUARTZ = registerBlock("planted_quartz", () -> new PlantedQuartzBlock(getProperties(Material.STONE).strength(1.5F).harvestLevel(0).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().noCollission().sound(SoundType.NETHER_ORE)));
    ...
    public static final RegistryObject<Block> CRIMSON_NYLIUM_CARPET = registerBlockWithDefaultItem("crimson_nylium_carpet", () -> new NetherCarpetBlock(BlockBehaviour.Properties.of(Material.CLOTH_DECORATION, MaterialColor.CRIMSON_NYLIUM).strength(0.1F).sound(SoundType.NYLIUM)));
