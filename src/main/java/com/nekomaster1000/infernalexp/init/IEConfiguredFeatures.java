...
public class IEConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> GLOWSTONE_RAVINE = registerConfiguredFeature("glowstone_ravine", IEFeatures.GLOWSTONE_RAVINE.configured(FeatureConfiguration.NONE).decorated(Features.Decorators.HEIGHTMAP_DOUBLE_SQUARE.count(120)));
    ...
    public static ConfiguredFeature<?, ?> CANYON_BLACKSTONE_BLOBS = registerConfiguredFeature("glowcanyon_blackstone_blob", Feature.REPLACE_BLOBS.configured(new ReplaceSphereConfiguration(IEBlocks.DULLSTONE.get().defaultBlockState(), Blocks.BLACKSTONE.defaultBlockState(), UniformInt.of(2, 3))).range(128).squared().count(8));
    public static ConfiguredFeature<?, ?> ORE_GLOWSILK_COCOON = registerConfiguredFeature("ore_glowsilk_cocoon", Feature.NO_SURFACE_ORE.configured(new OreConfiguration(OreConfiguration.Predicates.NETHER_ORE_REPLACEABLES, IEBlocks.GLOWSILK_COCOON.get().defaultBlockState(), 2)).decorated(FeatureDecorator.DEPTH_AVERAGE.configured(new DepthAverageConfigation(20, 10))).squared());
    public static ConfiguredFeature<?, ?> ORE_BASALT_IRON_BASALT_DELTA = registerConfiguredFeature("ore_basalt_iron_basalt_deltas", Feature.ORE.configured(new OreConfiguration(BASALT, IEBlocks.BASALT_IRON_ORE.get().defaultBlockState(), 8)).decorated(Features.Decorators.RANGE_10_20_ROOFED).squared().count(18));
    public static ConfiguredFeature<?, ?> ORE_BASALT_IRON_DELTA_SHORES = registerConfiguredFeature("ore_basalt_iron_delta_shores", Feature.ORE.configured(new OreConfiguration(BASALT, IEBlocks.BASALT_IRON_ORE.get().defaultBlockState(), 8)).decorated(Features.Decorators.RANGE_10_20_ROOFED).squared().count(8));
    ...
    public static ConfiguredFeature<?, ?> BASALTIC_MAGMA = registerConfiguredFeature("basaltic_magma", Feature.ORE.configured(new OreConfiguration(BASALT, IEBlocks.BASALTIC_MAGMA.get().defaultBlockState(),10)).decorated(Features.Decorators.RANGE_10_20_ROOFED).squared().count(8));
    public static ConfiguredFeature<?, ?> PATCH_WARPED_CAP = registerConfiguredFeature("patch_warped_cap", Feature.RANDOM_PATCH.configured((new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(IEBlocks.WARPED_FUNGUS_CAP.get().defaultBlockState()), new SimpleBlockPlacer())).tries(64).whitelist(ImmutableSet.of(Blocks.WARPED_NYLIUM.getBlock())).noProjection().build()).range(128).chance(16));
    ...
    public static ConfiguredFeature<?, ?> SHROOMLIGHT_TEAR = registerConfiguredFeature("shroomlight_tear", IEFeatures.SHROOMLIGHT_TEAR.configured(FeatureConfiguration.NONE).range(128).squared().count(100).chance(1));
